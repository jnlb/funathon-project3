...
# Same 10 CLC+ Backbone classes as defined in 1-acquisition.qmd / 4-inference.qmd —
# kept inline here so this page can render standalone, without sharing Python state.
classes = [
    ("Sealed (1)",                        "#FF0100"),
